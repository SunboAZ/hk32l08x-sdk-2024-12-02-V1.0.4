...
int main(void)
{
    ...
    /* TIM1 and Timers(TIM3 and TIM2) synchronisation in parallel mode
       1/TIM1 is configured as Master Timer:
       - PWM Mode is used
       - The TIM1 Update event is used as Trigger Output

       2/TIM3 and TIM2 are slaves for TIM1,
       - PWM Mode is used
      ...
      (TIM1 frequency)/ ((TIM2 period +1)* (Repetition_Counter+1)) = 28.125 KHz and
    ...
    /* TIM2 Slave Configuration: PWM1 Mode */
...
/**
  * @brief  Configures TIM1, TIM3 and TIM2 Pins.
  * @param  None
  * @retval None
  */
static void GPIO_Configuration(void)
{
    ...
    /* GPIOA Configuration: TIM1 Channel1 and TIM2 Channel1 as alternate function push-pull */
