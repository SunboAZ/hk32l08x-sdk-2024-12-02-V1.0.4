...
int main(void)
{
    ...
    */
    ...
    /* Start to  continue */
    printf("Wait for User push-button press to start OPAMP internal Follower ...\r\n");
    ...
    while (1)
    {
        if (uADC_EOCFlag)
        {
            ...
            Delay(0x3FFFF);
            printf(" After OPAMP1 internal Follower,The measured voltage:%f\r\n", ADCVal);
        }
    }
}
...
static void OPAMP_Config(void)
{
    ...
    OPAMP_InitStructure.InputInverting = OPAMP_MODE_FOLLOWER;
