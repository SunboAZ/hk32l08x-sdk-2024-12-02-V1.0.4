...
/**
  ...
  * @retval None
  */
void HK_EVAL_VCPComInit(USART_InitTypeDef* USART_InitStruct)
{
    GPIO_InitTypeDef GPIO_InitStructure;

    /* Enable GPIO clock */
    RCC_AHBPeriphClockCmd(VCP_USARTx_TX_GPIO_CLK | VCP_USARTx_RX_GPIO_CLK, ENABLE);

    /* Enable UART clock */
    RCC_APB1PeriphClockCmd(VCP_USARTx_CLK, ENABLE);

    GPIO_PinAFConfig(VCP_USARTx_TX_GPIO_PORT, VCP_USARTx_TX_SOURCE, VCP_USARTx_TX_AF);
    GPIO_PinAFConfig(VCP_USARTx_RX_GPIO_PORT, VCP_USARTx_RX_SOURCE, VCP_USARTx_RX_AF);
...
void USART_Config_Default(void)
{
    ...
    */
    ...
    HK_EVAL_VCPComInit(&USART_InitStructure);
