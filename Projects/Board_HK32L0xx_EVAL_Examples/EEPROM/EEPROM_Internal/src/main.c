...
int main(void)
{
    ...
    I2C_EepromBufferWrite(sEE_WRITE_ADDRESS1, Tx1_Buffer, BUFFER_SIZE1);

    /* Set the Number of data to be read */
    NumDataRead = BUFFER_SIZE1;

    /* Read from I2C EEPROM from sEE_READ_ADDRESS1 */
    EEPROM_Read(sEE_READ_ADDRESS1, Rx1_Buffer, NumDataRead);
    ...
    I2C_EepromBufferWrite(sEE_WRITE_ADDRESS2, Tx2_Buffer, BUFFER_SIZE2);
    /* Set the Number of data to be read */
    NumDataRead = BUFFER_SIZE2;
    /* Read from I2C EEPROM from sEE_READ_ADDRESS2 */
    EEPROM_Read(sEE_READ_ADDRESS2, Rx2_Buffer, NumDataRead);
