...
* @filename:  hk32l0xx_eval_spi_sd.c
* @brief:     This file provides a set of functions needed to manage the SPI SD
*             Card memory mounted on HK32L0XX-EVAL board.
* @author:    AE Team
...
/* Includes ------------------------------------------------------------------*/
#include "hk32l0xx_eval_spi_sd.h"
...
/** @defgroup   HK32_EVAL_SPI_SD
  * @brief      This file includes the SD card driver of HK32L0XX-EVAL boards.
  * @{
  */
...
/**
  ...
  * @note   Transfer on SPI bus management ensured by the HK_SPI_WriteRead() function
  * @param  Data: byte to send.
  * @retval None
  */
uint8_t SD_WriteByte(uint8_t Data)
{
    return HK_SPI_WriteRead(Data);
}
...
{
    return HK_SPI_WriteRead(SD_DUMMY_BYTE);
}
